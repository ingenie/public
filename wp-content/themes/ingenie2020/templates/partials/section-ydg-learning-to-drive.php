...
<div class="flex flex-wrap p-1 md:w-1/2 ig-break">
    ...
    <div class="w-full">
		...
		\ingenie2020Theme\View::render( 'YdgCatHeadingsView', [
            ...
            'txtColor' => 'text-ydg-learning-to-drive-800 hover:text-ydg-learning-to-drive-600',
        ...
        <div class="relative justify-center mb-5 text-center bg-gray-200 md:pb-6 md:mb-0 md:row-span-1 md:col-span-1">
            ...
            <div class="flex md:flex-wrap md:mb-0">
                ...
                <div class="flex-auto p-2 pl-4 text-left bg-gray-200 md:pl-2">
                    <h3 class="mb-2 text-sm font-bold leading-tight text-gray-900 uppercase md:h-10 md:text-xs">
                        <?php 
