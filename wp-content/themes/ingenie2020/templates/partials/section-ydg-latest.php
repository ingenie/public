...
<div class="ig-break mb-3 pb-3">
    ...
    <div class="hidden py-0 mx-3 md:block">
    ...
    <!-- Start main grid -->
    <div class="grid px-3 md:grid-rows-4 md:grid-cols-8 md:gap-2">
        ...
        <div class="flex flex-wrap pt-3 pb-0 sm:hidden">
            <div class="flex-auto sm:flex-1">
                <div class="flex pb-0">
                    <div class="w-32">
                        <h2
        ...
        <div class="relative mb-5 md:mb-0 justify-center text-center md:row-span-2 md:col-span-2 bg-gray-200">
            ...
            <div class="flex md:flex-wrap md:mb-0">
                ...
                foreach($terms as $term){
                    ...
                    <?php echo
                '<span class="text-ydg-'.implode(' ', $slug_out).'-500 right-0 bottom-0 pb-2 pr-2 absolute">'; ?>
