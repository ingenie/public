<?php
/*
 * Template Name: Learner FAQs Template
 * Template Post Type: post, page, whatever
 */

get_header(); ?>
<h1 class="heading-1 text-center pb-0">Learner Driver Insurance FAQs</h1>
<div class="py-0">
    <img class="h-full w-full object-cover hidden md:block" src="/resources/img/pages/hero-banners/yd-faqs.svg"
        alt="learner driver frequently asked questions">
...
<div class="bg-ig-li-blue-500 text-center p-8 mb-6">
    ...
    <div class="max-w-2xl m-auto">
        <button class="filter primary-btn my-1" data-id="your-insurance">Your insurance</button>
        <button class="filter primary-btn my-1" data-id="learner-app">The ingenie Learner app</button>
...
<div id="faqs" class="container mx-auto">
    ...
    <?php get_template_part('templates/partials/faqs/section', 'learner-faq-your-insurance'); ?>
    <?php get_template_part('templates/partials/faqs/section', 'learner-faq-learner-app'); ?>
    <?php get_template_part('templates/partials/faqs/section', 'learner-faq-claims'); ?>

</div>

<div class="text-sm text-center py-4 my-8">
    <?php echo do_shortcode("[get-message color='info' message='Read about your ingenie Learner Driver insurance in detail in your policy documents' link='/learner-driver-insurance/policy-information']"); ?>
</div>
